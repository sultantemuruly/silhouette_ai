  ...
  return (
    <div className="flex flex-col lg:flex-row w-full h-auto lg:h-[32rem] gap-4 sm:gap-6">
      ...
      <div className="w-full lg:w-[60%] flex flex-col mb-4 lg:mb-0">
        ...
        <textarea className="w-full flex-1 border border-input rounded-lg hover:border-blue-600 focus:ring-blue-600 p-2 sm:p-4 resize-none min-h-[8rem] sm:min-h-[10rem] lg:min-h-0 text-sm sm:text-base" placeholder="Write your message here..." />
      </div>
      {/* AI Chat Section */}
